namespace pickers {
  ...
  export namespace utils {
    ...
    export function dateTimeFormat(locale, options) {
      console.warn(locale === 'en-US', `Material-UI: The ${locale} locale is not supported by the built-in DateTimeFormat.
      ...
      this.format = function (date) {
        if (options.month === 'short' && options.weekday === 'short' && options.day === '2-digit') {
          ...
          console.warn(false, 'Material-UI: Wrong usage of DateTimeFormat');
        }
      };
    }
