...
declare namespace ReactRedux 
{
    ...
    export interface InferableComponentEnhancerWithProps<TInjectedProps, TNeedsProps> {
        ...
        ): React.ComponentClass<Omit<P, keyof Shared<TInjectedProps, P>> & TNeedsProps> & {WrappedComponent: React.ComponentType<P>}
    }
    ...
    interface MapDispatchToPropsFactory<TDispatchProps, TOwnProps> {
        (dispatch: Redux.Dispatch, ownProps: TOwnProps): MapDispatchToProps<TDispatchProps, TOwnProps>;
    }
    ...
    export interface SelectorFactory<S, TProps, TOwnProps, TFactoryOptions> {
        (dispatch: Redux.Dispatch, factoryOptions: TFactoryOptions): Selector<S, TProps, TOwnProps>
    }
    ...
    export interface ProviderProps<A extends Redux.Action = Redux.AnyAction> {
        /**
     ...
     */
    export class Provider<A extends Redux.Action = Redux.AnyAction> extends React.Component<ProviderProps<A>> { }
