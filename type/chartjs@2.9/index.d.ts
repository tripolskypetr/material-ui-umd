...
declare namespace Chart {
    ...
    interface ChartPoint {
        x?: number | string | Date | moment.Moment;
        y?: number | string | Date | moment.Moment;
        r?: number;
        t?: number | string | Date | moment.Moment;
    }
    ...
    interface ChartData {
        labels?: Array<string | string[] | number | number[] | Date | Date[] | moment.Moment | moment.Moment[]>;
