...
namespace mark {
  ...
  export namespace webcomponents {
    ...
    const createCamRoi = (
      ...
      const createArea = (
        ...
        [
          ...
          [setRight, right],
          [setBottom, bottom],
        ].forEach(([c, v]) => (c as (v: any, i: boolean) => void)(v, true));
      ...
      ].map((cfg: [boolean, boolean, (v: any) => void, (v: any) => void]) => createControl(...cfg));
    ...
    customElements.define('area-selector', AreaSelector as any);
