...
> Для того, чтобы научиться программировать, нужно жить программированием. Постоянно пробуйте написать программы, практикуйте творчество. Воюйте с рутиной, предлагая преподавателям написать программу за зачет автоматом, договаривайтесь и помните:
